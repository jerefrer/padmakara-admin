...
const EASYPAY_CHECKOUT_SDK = "https://cdn.easypay.pt/checkout/2.4.0/";
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    #easypay-checkout { width: 100%; max-width: 500px; min-height: 400px; }
  ...
  <script>
    ...
    easypayCheckout.startCheckout(manifest, {
      ...
      onError: function(error) {
        ...
        document.getElementById('easypay-checkout').innerHTML = '<p class="error">Payment failed. Please try again.</p>';
        setTimeout(function() { window.location.href = ${JSON.stringify(cancelUrl)}; }, 3000);
      },
      onClose: function() {
