export const pt = {
  ...
  padmakara: {
    ...
    import: {
      scanningFolder: "A analisar a pasta…",
      scanningFiles: "A analisar ficheiros de áudio…",
      startingAnalysis: "A iniciar análise…",
      processing: "A processar…",
      working: "A trabalhar…",
      parsedSummary: "Analisados {{files}} ficheiros em {{sessions}} sessões",
      aiAnalysisStarting: "A iniciar análise por IA ({{chunks}} lotes)…",
      chunkProgress: "A analisar… ({{done}}/{{total}} lotes concluídos)",
      chunkFailed: "Lote {{index}} falhou — a usar fallback",
      cancel: "Cancelar",
