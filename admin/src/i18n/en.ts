...
export const en = {
  ...
  padmakara: {
    ...
    import: {
      ...
      scanningFiles: "Scanning audio files…",
      startingAnalysis: "Starting analysis…",
      processing: "Processing…",
      working: "Working…",
      parsedSummary: "Parsed {{files}} files across {{sessions}} sessions",
      aiAnalysisStarting: "Starting AI analysis ({{chunks}} chunks)…",
      chunkProgress: "Analysing… ({{done}}/{{total}} chunks done)",
      chunkFailed: "Chunk {{index}} failed — using fallback",
      cancel: "Cancel",
