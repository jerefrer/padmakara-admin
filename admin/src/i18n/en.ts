...
export const en = {
  ...
  padmakara: {
    ...
    import: {
      ...
      cancel: "Cancel",
      dropPrompt: "Drop a retreat folder here",
      dropPromptHint: "MP3, WAV, M4A, FLAC, OGG — AI will analyse naming and structure",
      filesLoadedSummary: "{{count}} files from {{folder}}",
      dropToReplace: " — drop a new folder to replace",
